# Chalkboard 复古教学黑板与演示激光笔

- **生产域名**: `https://chalkboard.eazyopc.com`
- **功能定位**: 面向在线教师与内容创作者的复古墨绿与哑光碳黑黑板，具备真实碳酸钙粉笔散点颗粒特效与讲解激光笔。
...
1. 在 GitHub 建立公开仓库并推送：
   ```bash
   cd /Users/huafire777/Desktop/program/chalkboard
   git init
   git add .
   git commit -m "feat: initial commit for chalkboard"
   gh repo create chalkboard --public --source=. --remote=origin --push
   ```
2. 登录 [Cloudflare Dashboard](https://dash.cloudflare.com/)：
   ...
   - **构建预设**: `None`（纯静态项目）；
   - 点击 **保存并部署**。
3. 在自定义域绑定 `chalkboard.eazyopc.com`，并在 Namecheap 加一条 CNAME 记录即可！
